...
function musicaJuego(){
	...
	if(sonidos=="si"){
		var audio1 = new Audio('./res/sounds/musica-menu1.mp3');
		var audio2 = new Audio('./res/sounds/musica-menu2.mp3');
		var audio3 = new Audio('./res/sounds/musica-menu3.mp3');
		cont=0;
		audio1.play();
...
function reproSon(nombre){
	...
	if(sonidos=="si"){
		var audio1 = new Audio('./res/sounds/'+nombre);
		audio1.play();
	}
}
